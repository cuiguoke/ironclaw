...
- GitHub webhook delivery configured to `POST /api/webhooks/github`.
- Optional webhook secret configured (`GITHUB_WEBHOOK_SECRET` or gateway setting `github.webhook_secret`).
